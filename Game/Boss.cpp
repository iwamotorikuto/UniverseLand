...
bool Boss::Start()
{
	...
	//モデルを読み込む。
	m_modelRender.Init("Assets/modelData/Boss/Boss.tkm");
...
void Boss::Update()
{
   ...
   //PlayAnimation();
	...
	//PhysicsWorld::GetInstance()->ContactTest(m_player->m_charaCon, [&](const btCollisionObject& cont)
	//	{
	//		if (btGhostObject)
	//	}
